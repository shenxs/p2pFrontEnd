  ...
  <div class="g-register">
    ...
    <el-form
      ...
      <el-form-item label="账号" prop="account">
        <el-input v-model="ruleForm.username" placeholder="请设定您的账号"/>
      </el-form-item>
      <el-form-item label="密码" prop="password">
        <el-input v-model="ruleForm.password" placeholder="请设定您的密码" type="password"/>
      </el-form-item>
      <el-form-item label="重复密码" prop="password2">
        <el-input v-model="ruleForm.password2" placeholder="请再次输入密码" type="password"/>
      </el-form-item>
        ...
        <el-row :gutter="10" type="flex">
          <el-col :span="40">
            <el-input
              ...
              type="number"
              @blur="inputBlur('verificationCode',ruleForm.verificationCode)"/>
          </el-col>
          <el-col :span="1">
...
export default {
  name: 'Register',
  data() {
    const passwordEqual = (rule, val, callback) => {
      if (val === '') {
        callback(['请输入密码'])
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          if (this.ruleForm.password !== this.ruleForm.password2) {
            ...
            const role = ((is) => { if (is === true) return 'admin'; else return 'user' })(this.ruleForm.isadmin)
