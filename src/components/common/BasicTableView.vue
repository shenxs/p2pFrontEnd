    ...
    <div class="basicTable">
        ...
        <div class="u-table-title">
            ...
            <div class="m-filter-container">
                <el-input style="width: 200px" placeholder="请输入用户名"></el-input>
                <el-select :value="queryValue" class="f-filter-item">
                    <el-option v-for="item in importanceOptions" :key="item" :label="item" :value="item"/>
                </el-select>

                <el-select v-model="listQuery.type" :value='queryValue' clearable class="f-filter-item"
                           style="width: 130px">
            ...
            <el-table
                ...
                <el-table-column v-if="review"
                                 fixed="right"
                                 label="审核"
                                 width="150" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">

                        <el-button @click="makeReview(scope.row,'pass',scope)" type="success" size="mini">
                            通过
                        </el-button>
                        <el-button @click="makeReview(scope.row,'reject',scope)" size="mini" type="danger">
                            拒绝
                        </el-button>
                    </template>
                </el-table-column>
